...
| internalLbStaticIPOffset     | no                                        | The master internal load balancer frontend IP address is offset by this number from the first master IP. If this is not set, a default offset of 10 will be used.                                                                                                                                                                                                                                                                                                                 |
